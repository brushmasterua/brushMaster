...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        "relative inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-2 rounded-xl px-5 py-2 text-sm font-bold whitespace-nowrap transition-all",
        ...
        // Неактивний стан
        "bg-transparent text-gray-600 hover:text-gray-900 hover:bg-white hover:shadow-md",
        
        // Активний стан - помаранчевий
        "data-active:bg-white data-active:text-[#f97316] data-active:shadow-md",
        
        // Для variant="line"
        "group-data-[variant=line]/tabs-list:bg-transparent",
        "group-data-[variant=line]/tabs-list:data-active:bg-transparent",
        
        // Лінія під активним табом (опціонально)
        "after:absolute after:bg-[#f97316] after:opacity-0 after:transition-opacity",
